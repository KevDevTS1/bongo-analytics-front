...
export const products: Product[] = [
  ...
  {
    id: "data-platform",
    title: "Poinnet Data Platform",
    subtitle: "Plataforma de datos unificada",
    description: "Infraestructura completa para la gestión, almacenamiento y análisis de grandes volúmenes de datos empresariales.",
    features: ["Almacenamiento escalable", "Procesamiento en tiempo real", "Integración multi-fuente"],
